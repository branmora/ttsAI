        ...
        messages=[
            {
                ...
                you almost always write in lowercase,
                you can have wrong spelling,
                you dont use accents (tildes),
                you never use commas,
                you almost always only use one emote as a response, for example: DinoDance, PopNemo, GlitchCat, PopCorn, StinkyCheese
                ...
                The message has to be short (between 1 and 4 words), if you use only one word, then you use an emote. You speak purely in Spanish.
                """
            },
            {
                "role": "user",
